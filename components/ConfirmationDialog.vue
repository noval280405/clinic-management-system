  ...
  >
    <div class="modern-card">
      ...
      <div class="footer-actions">
        ...
        <button class="btn-confirm" :class="variant" @click="onConfirm">
          {{ confirmText }}
        </button>
      </div>
    </div>
...
.modern-card {
  ...
  overflow: hidden;
  font-family:
    "Inter", sans-serif; /* Pastikan font ini tersedia atau gunakan sans-serif standar */
}
...
.header-decoration.default .icon-box {
  color: #3b82f6;
  border: 1.5px solid #dbeafe;
}
.header-decoration.danger .icon-box {
  color: #ef4444;
...
.header-decoration.default .blur-blob {
  background: #3b82f6;
}
.header-decoration.danger .blur-blob {
  background: #ef4444;
}
